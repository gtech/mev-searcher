...
task("flashloan", async (_, hre) => {
  ...
  module.exports = {
    ...
    networks: {
      alchemy:{
        url: "https://eth-mainnet.alchemyapi.io/v2/7iK_P5rb5W1o7oM97IQWboQ3oVLjVq8D",
        accounts: ["c0364ff598650c3b8ee486dad273f18ebd919e24844574d5b1a2f1d57e13cf83"] //MEV tester
      },
      hardhat: {
        forking: {
          url: "https://eth-mainnet.alchemyapi.io/v2/7iK_P5rb5W1o7oM97IQWboQ3oVLjVq8D",
